...
void Game::LoadLevel(Uint8 levelNumber)
{
    ...
    tank.AddComponent<ProjectileEmitterComponent>(glm::vec2(100, 0), 3000, 10000, 25, false);
    ...
    truck.AddComponent<ProjectileEmitterComponent>(glm::vec2(0, 50), 500, 10000, 25, false);
}
